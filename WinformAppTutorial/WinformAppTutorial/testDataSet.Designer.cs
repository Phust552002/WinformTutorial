...
namespace WinformAppTutorial {
    ...
    public partial class testDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(string UserName, string Password, int DepartmentID, System.DateTime DateOfBirth) {
...
namespace WinformAppTutorial.testDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employee] WHERE (([UserID] = @Original_UserID) AND ([UserName] = @Original_UserName) AND ([Password] = @Original_Password) AND ((@IsNull_DepartmentID = 1 AND [DepartmentID] IS NULL) OR ([DepartmentID] = @Original_DepartmentID)) AND ((@IsNull_DateOfBirth = 1 AND [DateOfBirth] IS NULL) OR ([DateOfBirth] = @Original_DateOfBirth)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([UserName], [Password], [DepartmentID], [DateOfBirt" +
                "h]) VALUES (@UserName, @Password, @DepartmentID, @DateOfBirth);\r\nSELECT UserID, " +
                "UserName, Password, DepartmentID, DateOfBirth FROM Employee WHERE (UserID = SCOP" +
                "E_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [UserName] = @UserName, [Password] = @Password, [DepartmentID] = @DepartmentID, [DateOfBirth] = @DateOfBirth WHERE (([UserID] = @Original_UserID) AND ([UserName] = @Original_UserName) AND ([Password] = @Original_Password) AND ((@IsNull_DepartmentID = 1 AND [DepartmentID] IS NULL) OR ([DepartmentID] = @Original_DepartmentID)) AND ((@IsNull_DateOfBirth = 1 AND [DateOfBirth] IS NULL) OR ([DateOfBirth] = @Original_DateOfBirth)));
SELECT UserID, UserName, Password, DepartmentID, DateOfBirth FROM Employee WHERE (UserID = @UserID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WinformAppTutorial.Properties.Settings.Default.testConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, UserName, Password, DepartmentID, DateOfBirth FROM dbo.Employee";
        ...
        public virtual int Delete(int Original_UserID, string Original_UserName, string Original_Password, global::System.Nullable<int> Original_DepartmentID, global::System.Nullable<global::System.DateTime> Original_DateOfBirth) {
        ...
        public virtual int Insert(string UserName, string Password, global::System.Nullable<int> DepartmentID, global::System.Nullable<global::System.DateTime> DateOfBirth) {
            if ((UserName == null)) {
        ...
        public virtual int Update(string UserName, string Password, global::System.Nullable<int> DepartmentID, global::System.Nullable<global::System.DateTime> DateOfBirth, int Original_UserID, string Original_UserName, string Original_Password, global::System.Nullable<int> Original_DepartmentID, global::System.Nullable<global::System.DateTime> Original_DateOfBirth, int UserID) {
            if ((UserName == null)) {
                throw new global::System.ArgumentNullException("UserName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string UserName, string Password, global::System.Nullable<int> DepartmentID, global::System.Nullable<global::System.DateTime> DateOfBirth, int Original_UserID, string Original_UserName, string Original_Password, global::System.Nullable<int> Original_DepartmentID, global::System.Nullable<global::System.DateTime> Original_DateOfBirth) {
            return this.Update(UserName, Password, DepartmentID, DateOfBirth, Original_UserID, Original_UserName, Original_Password, Original_DepartmentID, Original_DateOfBirth, Original_UserID);
        }
    }
